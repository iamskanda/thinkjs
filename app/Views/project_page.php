                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <i type="button" data-toggle="tooltip" data-placement="left" title="Add Project" class="fas fa-plus-square add_branch" style="color: #3e5871; font-size: 1.5em; float: right; cursor: pointer; margin-right: 0.5em;"></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <form id="add_branch_m" enctype="multipart/form-data">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-sm-6">
                                        <label>NOTE</label>
                                        <textarea class="form-control" id="note" name="note" rows="2" cols="30" maxlength="200">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div>
                            <form id="update_project" enctype="multipart/form-data">
